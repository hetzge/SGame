...
public enum Orientation {
	...
	NORTH(new XY(0, -1)), EAST(new XY(1, 0)), SOUTH(new XY(0, 1)), WEST(new XY(-1, 0)), NORTH_EAST(new XY(1, -1)), SOUTH_EAST(new XY(1, 1)), SOUTH_WEST(
			new XY(-1, 1)), NORTH_WEST(new XY(-1, -1));
